...
const AdminHeader: React.FC<AdminHeaderProps> = ({ profile, activeSection, onLogout }) => (
  <header className="sticky top-0 z-10 flex items-center justify-between border-b border-border/60 bg-white/90 px-4 py-4 backdrop-blur-sm lg:px-6">
    <div className="flex items-center gap-4">
      <h1 className="text-xl font-semibold text-foreground">{activeSection}</h1>
    </div>
